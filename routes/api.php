...
Route::namespace('App\Http\Controllers\API\Common')->group(function () {
    ...
    Route::group(['middleware' => 'auth:api'],function () {
        ...
        Route::controller(DprImportController::class)->group(function () {
            ...
            Route::post('dpr-import-delete','destroy')->name('dpr-import-delete');
            ...
            Route::post('download-summary-report','downloadSummaryReport')->name('download-summary-report');
        });
...
Route::namespace('App\Http\Controllers\API\Admin')->group(function () {
    ...
    Route::group(['middleware' => 'auth:api'],function () {
        ...
        Route::controller(UserController::class)->group(function () {
         ...
         Route::controller(OverAllReportEmailController::class)->group(function () {
            Route::post('reportEmails', 'reportEmails')->name('reportEmails');
            Route::apiResource('report-email', OverAllReportEmailController::class)->only(['store','show', 'update','destroy']);
