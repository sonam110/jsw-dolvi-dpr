                ...
                <div class="col-lg-12 col-sm-6 mb-4">
                  <div class="card">
                    <div class="card-header border-bottom" >
                      <h4 class="text-primary fw-bolder mb-0 card-title">DPR Report</h4>
                    ...
                    <div class="card-header border-bottom" >
                      <div class="row">
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6" id="datefrom" >
                          ...
                          <div class="form-group">
                           <input type="text" name="date_date" id="date_date" class="form-control" placeholder="Data date">
                         </div>
                         </div>
                        <div class="col-lg-2 col-sm-6 mb-4">
                          <label class="form-label" for="date">Select Vendor </label>
                      ...
                      <div class="col-lg-2 col-sm-6 mb-4">
                         <label class="form-label" for="date">Select Project </label>
                      ...
                      <div class="col-lg-3 col-sm-6 mb-4">
                        <label class="form-label" for="date">Item Description </label>
                      ...
                      <div class="col-lg-2 col-sm-6 mb-4 margin-class">
                        <button type="button"  class="btn btn-primary extraDd">Submit</button>
                      </div>
                     </div>
                     <div class="row" id="download-div" style="display:none;">
                      <div class="col-md-3"><button type="button" class="btn btn-primary d-block w-100" data-type="pdf"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg> Pdf</button></div>
                      <div class="col-md-3"><button type="button" class="btn btn-primary d-block w-100" data-type="excel"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg> Excel</button></div>
                      <div class="col-md-3"><button type="button" class="btn btn-primary d-block w-100" data-type="html"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg> Html</button></div>
