...
class ProjectController extends Controller
{
    ...
    public function projects(Request $request)
    {
        try {
            ...
            $query = Project::orderby('orderno','ASC')->whereIn('status',['1','2']);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $project->dpr_report_emails = $request->dpr_report_emails;
            $project->reminder_emails = $request->reminder_emails;
            $project->status = $request->status ? $request->status : 1;
            $project->orderno = $request->orderno ? $request->orderno : 1;
    ...
    public function action(Request $request)
    {
        ...
        try 
        {
            ...
            {
                Project::whereIn('id',$ids)->update(['status'=>"3"]);
