...
class NoMiddlewareController extends Controller
{
    ...
    public function dprConfigs(Request $request)
    {
        try {
            ...
            $query = DprConfig::orderby($column,$dir)->with('vendor','Project','DprMap','user:id,name')
            ...
            if(!empty(auth()->user()->project_ids))
            {
                ...
                $query->whereIn('dpr_configs.project_id',$project_ids);
            }
    ...
    public function projects(Request $request)
    {
        try {
            ...
            $query = Project::orderby($column,$dir)->whereIn('status',['1','2']);
    ...
    public function itemDescList(Request $request)
    {
        try {
            ...
            if(!empty(auth()->user()->dpr_item_desc_ids))
            {
                ...
                $allData->whereIn('id',$dpr_item_desc_ids);
            }
