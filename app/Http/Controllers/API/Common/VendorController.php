...
class VendorController extends Controller
{
    ...
    public function destroy($id)
    {
        try {
            ...
            })->where('dpr_configs.vendor_id',$id)->count();
            if($checkImport >0){
                 return response(prepareResult(true, [],"You can't delete this vendor, import file exists on behalf of this vendor"), config('httpcodes.bad_request'));
            }
