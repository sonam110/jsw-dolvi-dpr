...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $user->project_ids = $request->project_ids;
            $user->dpr_item_desc_ids = $request->dpr_item_desc_ids;
    ...
    public function show($id)
    {
        try {
            ...
            $project_ids = (!empty($userinfo->project_ids)) ? explode(',',$userinfo->project_ids) :[];
            $role   = Role::where('id', $userinfo->role_id)->first();
            $query = DprConfig::select(array('dpr_configs.id','dpr_configs.vendor_id','vendors.id as vendor_id','vendors.name as vendor_name'))
